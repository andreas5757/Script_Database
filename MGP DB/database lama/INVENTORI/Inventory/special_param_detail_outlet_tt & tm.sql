...
select*from special_param_detail_outlet_tt;
select*from special_param_detail_outlet_tm;
truncate table special_param_detail_outlet_tt;
truncate table special_param_detail_outlet_tm;
